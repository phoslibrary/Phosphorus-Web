...
function NavBase(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(NavMobile_1.NavMobile, Object.assign({ opened: opened, onClose: close }, props)), (0, jsx_runtime_1.jsx)(core_1.Box, { sx: backgroundStyle, children: (0, jsx_runtime_1.jsxs)(core_1.Container, { size: "md", px: "sm", sx: containerStyle, children: [(0, jsx_runtime_1.jsx)(core_1.UnstyledButton, { onClick: () => props.faviconClick, children: (0, jsx_runtime_1.jsxs)(core_1.Group, { children: [(0, jsx_runtime_1.jsx)(core_1.Image, { src: props.favicon, height: 25, width: "auto" }), isMobile && props.hideTypefaceMobile || !props.typeface ? null :
