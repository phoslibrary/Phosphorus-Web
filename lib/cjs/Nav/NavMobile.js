...
function NavMobile(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(core_1.Drawer, { opened: props.opened, onClose: () => props.onClose(), position: props.position, withCloseButton: false, zIndex: 9999, children: [(0, jsx_runtime_1.jsxs)(core_1.Container, { size: "md", px: "sm", sx: containerStyle, children: [(0, jsx_runtime_1.jsx)(phosphorus_core_1.ButtonBase, Object.assign({ square: true, style: Object.assign({ backgroundColor: "#FFFFFF00" }, props.faviconButtonProps.style) }, props.faviconButtonProps, { onClick: props.faviconButtonProps.onClick ? props.faviconButtonProps.onClick : () => props.onClose(), children: (0, jsx_runtime_1.jsx)(core_1.Image, { src: props.favicon, height: 25, width: "auto" }) })), (0, jsx_runtime_1.jsx)(phosphorus_core_1.ButtonBase, { onClick: () => props.onClose(), square: true, component: "div", variant: phosphorus_core_1.ButtonVariant.Subtle, children: (0, jsx_runtime_1.jsx)(core_1.Burger, { opened: props.opened }) })] }), (0, jsx_runtime_1.jsx)(phosphorus_core_1.Text, { family: props.typefaceFamily, weight: 800, size: 35, children: props.typeface }), (0, jsx_runtime_1.jsx)(core_1.Space, { h: 40 }), (0, jsx_runtime_1.jsx)(core_1.Stack, { sx: buttonDrawerStyle, onClick: () => props.onClose(), children: props.buttons })] }));
}
