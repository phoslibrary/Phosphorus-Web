...
import { Box, Container, Group, Image, Burger } from "@mantine/core";
...
export function NavBase(props) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(NavMobile, Object.assign({ opened: opened, onClose: close }, props)), _jsx(Box, { sx: backgroundStyle, children: _jsxs(Container, { size: "md", px: "sm", sx: containerStyle, children: [_jsx(ButtonBase, Object.assign({ style: Object.assign({ padding: 0, backgroundColor: "#FFFFFF00", color: "unset" }, props.faviconButtonProps.style) }, props.faviconButtonProps, { children: _jsxs(Group, { children: [_jsx(Image, { src: props.favicon, height: 25, width: "auto" }), isMobile && props.hideTypefaceMobile || !props.typeface ? null :
